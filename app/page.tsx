    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-ocean-500/20 via-transparent to-transparent" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center pt-20">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-white/5 border border-ocean-500/30 px-5 py-2 mb-8">
          ...
          <h1 className="font-heading text-5xl sm:text-6xl lg:text-8xl font-bold text-white mb-6 leading-tight">
            Marina
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-ocean-300 to-ocean-600">
              Towers
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/listings"
              className="bg-ocean-500 hover:bg-ocean-600 text-white px-10 py-4 text-sm font-bold tracking-widest uppercase transition-colors w-full sm:w-auto text-center"
            >
              Find Your Stay
            </Link>
            <Link
              href="/submit"
              className="border border-white/20 hover:border-ocean-500 text-white hover:text-ocean-400 px-10 py-4 text-sm font-bold tracking-widest uppercase transition-all w-full sm:w-auto text-center"
            >
              List Your Property
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 pt-12 border-t border-white/10 max-w-lg mx-auto">
            <div>
              <div className="text-ocean-400 font-heading text-3xl font-bold">42</div>
              <div className="text-white/40 text-xs tracking-wider uppercase mt-1">Floors</div>
            </div>
            <div>
              <div className="text-ocean-400 font-heading text-3xl font-bold">200+</div>
              <div className="text-white/40 text-xs tracking-wider uppercase mt-1">Residences</div>
            </div>
            <div>
              <div className="text-ocean-400 font-heading text-3xl font-bold">5★</div>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
          ...
          <div className="w-px h-12 bg-gradient-to-b from-ocean-500/50 to-transparent" />
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-white/5 border border-white/10 p-8 hover:border-ocean-500/30 transition-colors group"
              >
      ...
      <section className="py-24 bg-navy-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link
              href="/listings"
              className="hidden sm:inline-flex items-center gap-2 text-ocean-400 hover:text-ocean-300 text-sm font-medium transition-colors"
            >
              View All Listings
      ...
      <section className="py-24 bg-navy-950">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="font-heading text-3xl sm:text-5xl font-bold text-white mb-6">
            Own a Property at
            <span className="text-ocean-400"> Marina Towers</span>?
          </h2>
          ...
          <Link
            href="/submit"
            className="inline-block bg-ocean-500 hover:bg-ocean-600 text-white px-10 py-4 text-sm font-bold tracking-widest uppercase transition-colors"
          >
            Submit Your Listing
          </Link>
        </div>
